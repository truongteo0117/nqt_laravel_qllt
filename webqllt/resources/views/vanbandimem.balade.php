    ...
    <body id="minovate" class="appWrapper">
        ...
        <div id="wrap" class="animsition">
            ...
            <section id="header">
                <header class="clearfix">
                    ...
                    <ul class="nav-right pull-right list-inline">
                        ...
                        <li class="toggle-right-sidebar" style="margin-right: 20px;">
            ...
            <div id="controls">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        ==================================================== -->
                                        <ul id="navigation">
                                            <li><a href=""><i class="fa fa-dashboard"></i> <span>Trang Chủ</span></a></li>
                                            
                                            
                                            <li>
                                                <a href="#"><i class="fa fa-magic"></i> <span>Văn Bản</span></a>
                                                <ul>
                                                    <li>
                                                        <a href="#"><i class="fa fa-caret-right"></i>Văn Bản Cứng</a>
                                                        <ul>
                                                            <li><a href="http://localhost:8080/laravel8x/public/VBC/VBdi"><i class="fa fa-caret-right"></i>Văn Bản Đi</a></li>
                                                            <li><a href="http://localhost:8080/laravel8x/public/VBC/VBden"><i class="fa fa-caret-right"></i>Văn Bản Đến</a></li>
                                                            <!-- <li>
                                                    ...
                                                    <li>
                                                        <a href="#"><i class="fa fa-caret-right"></i>Văn Bản Mềm</a>
                                                        <ul>
                                                            <li><a href="http://localhost:8080/laravel8x/public/VBM/VBdi"><i class="fa fa-caret-right"></i>Văn Bản Đi</a></li>
                                                            <li><a href="http://localhost:8080/laravel8x/public/VBM/VBden"><i class="fa fa-caret-right"></i>Văn Bản Đến</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                ...
                ================================================== -->
                <aside id="rightbar">
                    <include src="E:/Dowload/web/minovate//Header.html"></include>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="tables-datatables.html">Văn Bản Cứng</a>
                                </li>
                                <li>
                                    <a href="tables-datatables.html">Văn Bản Đi</a>
                                </li>
                            </ul>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <form action="http://localhost:8080/laravel8x/public/handling" method="POST">
                                            {!! csrf_field() !!}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $stt++;  ?></td>
                                                <td>{{$row->id}}</td>
                                                <td><?php foreach ($lvb as $key)
                                                {
                                                    if ($key->id == $row->id_loaivanban)
                                                    {
                                                        echo $key->loaivanban;
                                                    }
                                                } ?></td>
                                                ...
                                                <td>{{$row->nguoinhan}}</td>
                                                <td>{{$row->nguoigui}}</td>
                                                <td class="actions"><a role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a role="button" href="http://localhost:8080/laravel8x/public/delete/<?php echo $row->id; ?>" tabindex="0" class="delete text-danger text-uppercase text-strong text-sm mr-10">Remove</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        </table>
        ...
        <script>
            $(window).load(function(){
                ...
                function showcommentform() {
                    alert('helo');
                    var data = '<form action="http://localhost:8080/laravel8x/public/create" method="POST">';
                ...
                function restoreRow(oTable, nRow) {
                    ...
                    // jqInputs[1].value = "<?php  ?>"
                    // <?php
                    //     }
                    // ?>

                    var aData = oTable.row(nRow).data();
                    oTable.cell(nRow, 0).data(aData[0]);
                    oTable.cell(nRow, 1).data(aData[1]);
                    oTable.cell(nRow, 2).data(aData[2]);
                    oTable.cell(nRow, 3).data(aData[3]);
                    oTable.cell(nRow, 4).data(aData[4]);
                    oTable.cell(nRow, 5).data(aData[5]);
                    oTable.cell(nRow, 6).data(aData[6]);
                    oTable.cell(nRow, 7).data(aData[7]);
                    oTable.cell(nRow, 8).data(aData[8]);
                    oTable.cell(nRow, 9).data(aData[9]);
                    oTable.cell(nRow, 10).data(aData[10]);
                    oTable.cell(nRow, 11).data('<a role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a  href="http://localhost:8080/laravel8x/public/delete/' +aData[0]+ '" class="text-danger text-uppercase text-strong text-sm mr-10">Remove</a>');
                    oTable.draw();
                ...
                function editRow(oTable, nRow) {
                    var aData = oTable.row(nRow).data();
                    var jqTds = $('>td', nRow);
                    jqTds[0].innerHTML = '<input type="text" class="form-control input-sm" readonly value="' + aData[0] + '">';
                    jqTds[1].innerHTML = '<input type="text" name="id" class="form-control input-sm" value="' + aData[1] + '">';
                    jqTds[2].innerHTML = '<select name="id_loaivanban" class="form-control input-sm"> <?php foreach ($lvb as $key){ ?> <option  value="<?php echo $key->id ?>"> <?php echo $key->loaivanban; ?></option><?php } ?></select>';
                    jqTds[3].innerHTML = '<input type="text" name="file" class="form-control input-sm" value="' + aData[3] + '">';
                    jqTds[4].innerHTML = '<input type="text" name="tenvb" class="form-control input-sm" value="' + aData[4] + '">';
                    jqTds[5].innerHTML = '<input type="text" name="sovb" class="form-control input-sm" value="' + aData[5] + '">';
                    jqTds[6].innerHTML = '<input type="text" name="mota" class="form-control input-sm" value="' + aData[6] + '">';
                    jqTds[7].innerHTML = '<input type="date" name="ngaygui" class="form-control input-sm" value="' + aData[7] + '">';
                    jqTds[8].innerHTML = '<input type="text" name="nguoiky" class="form-control input-sm" value="' + aData[8] + '">';
                    jqTds[9].innerHTML = '<input type="text" name="nguoinhan" class="form-control input-sm" value="' + aData[9] + '">';
                    jqTds[10].innerHTML = '<input type="text" name="nguoigui" class="form-control input-sm" value="' + aData[10] + '">';
                    jqTds[11].innerHTML = '<input type="submit" name="ok" class="btn btn-link" value="Save" style="color: green; margin-top: -3px;"><a role="button" tabindex="0" class="cancel text-warning text-uppercase text-strong text-sm mr-10">Cancel</a>';
                ...
                function saveRow(oTable, nRow) {
                    ...
                    oTable.cell(nRow, 9).data(jqInputs[9].value);
                    oTable.cell(nRow, 10).data(jqInputs[10].value);
                    oTable.cell(nRow, 11).data('<a role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a role="button" tabindex="0" class="delete text-danger text-uppercase text-strong text-sm mr-10">Remove</a>');
                    oTable.draw();
                }
