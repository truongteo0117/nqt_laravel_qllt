...
<head>
        ...
        <script src="https://kit.fontawesome.com/13693a739d.js" crossorigin="anonymous"></script>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        ==================================================== -->
                                        <ul id="navigation">
                                            <li><a href="index-2.html"><i class="fa fa-dashboard"></i> <span>Trang Chủ</span></a></li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="#"><i class="fa fa-caret-right"></i>Văn Bản Đi</a></li>
                                                            <li><a href="#"><i class="fa fa-caret-right"></i>Văn Bản Đến</a></li>
                                                            <!-- <li>
        ...
        <script>
            $(window).load(function(){
                ...
                function editRow(oTable, nRow) {
                    ...
                    jqTds[3].innerHTML = '<input type="text" name="ma_vb" class="form-control input-sm" value="' + aData[3] + '">';
