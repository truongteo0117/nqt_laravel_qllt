    ...
    <body id="minovate" class="appWrapper">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li class="active open">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="tables-datatables.html"><i class="fa fa-caret-right"></i> DataTables</a></li>
        ...
        <script>
            ...
            $(window).load(function(){
                ...
                //     jqTds[2].innerHTML = '<select name="id_loaivanban" class="form-control input-sm">  as $key){ ?> <option  val
